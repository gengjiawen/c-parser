  ...
  describe('_Alignof folding for struct and union tags', () => {
    const cases: [string, string, number][] = [
      ...
      [
        ...
        'struct S { long l; } __attribute__((packed, aligned(4)));',
        4,
      ],
      ['packed member', 'struct S { long l __attribute__((packed)); };', 1],
      ['packed and aligned member', 'struct S { long l __attribute__((packed, aligned(4))); };', 4],
      ['pragma-packed member', '#pragma pack(1)\nstruct S { long l; };', 1],
      [
        'pragma pack caps explicit member alignment',
        '#pragma pack(1)\nstruct S { long l __attribute__((aligned(8))); };',
        1,
      ],
      [
        'aggregate alignment overrides pragma pack',
        '#pragma pack(1)\nstruct S { long l; } __attribute__((aligned(8)));',
        8,
      ],
      ['function-pointer member', 'struct S { void (*fp)(void); };', 8],
      ['empty GNU struct', 'struct S { };', 1],
      ['unnamed zero-width bit-field', 'struct S { char c; int : 0; };', 1],
